...
class TempPasswordMailer:
    ...
    def send_notification(self, to_addr, temp_password ):
        ...
        body = f"Well met,<br><br>Your temporary password is: {temp_password}\n\nPlease use this password to log in and reset it as soon as possible.<br>If you have not requested a change, you can ignore this email."
